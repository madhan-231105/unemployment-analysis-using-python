...
#setting the title and text with custom styling
st.markdown("<h1 style='text-align: center; font-size: 4rem; color: #1f77b4; margin-bottom: 2rem;'>👨🏻‍🏭 Unemployment Analysis</h1>", unsafe_allow_html=True)
